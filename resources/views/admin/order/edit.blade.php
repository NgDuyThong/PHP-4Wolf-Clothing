    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card card-default">
                    ...
                    @foreach ($order_details as $order_detail)
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <img style="width: 70px; height:auto; object-fit: cover;" src="{{ asset("asset/client/images/products/small/$order_detail->products_color_img") }}" alt="">
                        </td>
          ...
          <div class="action col-md-12" style="padding-top: 10px;padding-bottom: 20px; padding-right: 30px;padding-left: 30px;">
            @if ($order->order_status != 3)
              <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal-lg">Xử Lý Đơn Hàng</button>
            @endif
...
<div id="data-order" info-customer="{{ json_encode($infomation_user) }}" products="{{ json_encode($order_details) }}"></div>
